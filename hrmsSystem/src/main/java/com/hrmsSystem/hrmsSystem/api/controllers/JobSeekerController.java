...
public class JobSeekerController {
	...
	@PostMapping("/add")
	public Result add(@RequestBody JobSeeker jobSeeker,MernisCheckManager mernisCheckManager ) throws NumberFormatException, RemoteException {
		return this.jobSeekerService.addToSystem(jobSeeker , mernisCheckManager);
	}
}
